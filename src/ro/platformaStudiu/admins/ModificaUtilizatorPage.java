...
public class ModificaUtilizatorPage {
    ...
    public ModificaUtilizatorPage(Stage primaryStage, SqlConexiune sql, int rolID, int userID) {
    ...
    private TableView<User> initializeTableView() {
        ...
        TableColumn<User, String> numarTelefonColumn = new TableColumn<>("Număr Telefon");
    ...
    private void updateUserInDatabase(User user) {
        String updateQuery = "UPDATE utilizatori SET nume = ?, prenume = ?, CNP = ?, numarTelefon = ?, adresa = ?, " +
                             "IBAN = ?, email = ?, parola = ? WHERE user_id = ?";
