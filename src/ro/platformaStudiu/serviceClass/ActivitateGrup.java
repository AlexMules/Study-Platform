...
public class ActivitateGrup extends Activitate {
    ...
    public ActivitateGrup (int activitate_id, int grup_id, int nr_curent_participanti, int nr_min_participanti,
                           String ziua, Time ora, String descriere, int durata, int timp_expirare) {
