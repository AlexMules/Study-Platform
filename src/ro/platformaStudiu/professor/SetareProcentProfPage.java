...
public class SetareProcentProfPage {
    ...
    public SetareProcentProfPage(Stage primaryStage, SqlConexiune sql, int user_id,int profesorID) {
        Label titleLabel = new Label("Stabiliți procentele pentru activitățile dumneavoastră:");
        ...
        Button set = new Button("Salvează Procentele");
        ...
        set.setOnAction(e -> {
                    ...
                    if (total != 100) {
                        statusLabel.setText("Eroare! Totalul procentelor trebuie să fie 100%!" + "\nTotal: " + total + "%");
        ...
        layout.getChildren().addAll(titleLabel,hboxCurs,comboCurs,hboxSeminar,comboSeminar,hboxLaborator,comboLaborator,
                                    statusLabel,set, inapoi);

        Scene scene = new Scene(layout, 1000, 600);
        primaryStage.setScene(scene);
        primaryStage.setTitle("Împărțire Procentuală");
        primaryStage.show();
    }
