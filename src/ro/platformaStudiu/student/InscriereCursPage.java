...
public class InscriereCursPage {
    ...
    public InscriereCursPage(Stage primaryStage, SqlConexiune sql, int user_id, int student_id) {
        ...
        Button inscriereButton = getButton(materiiComboBox, statusLabel);
        ...
        primaryStage.setTitle("Înscriere Curs");
        primaryStage.show();

    }

    private Button getButton(ComboBox<Materie> materiiComboBox, Label statusLabel) {
