...
public class ActivitateGrupPage {
    ...
    public ActivitateGrupPage(Stage primaryStage, SqlConexiune sql, int userID, int studentid, GrupStudiu grup) {
        ...
        Label nrMinParticipantiLabel = new Label("Nr. minim participanți:");
        ...
        Label ziuaCalendaristicaLabel = new Label("Data Calendaristică (YYYY-MM-DD):");
        ...
        Label oraLabel = new Label("Ora (HH:MM)");
        ...
        okButton.setOnAction(e -> {
            try {
                ...
                if (!oraText.matches("^([01]?\\d|2[0-3]):[0-5]\\d(:[0-5]\\d)?$")) {
                    throw new InvalidDateTimeException("Ora trebuie să fie în formatul HH:MM!");
                }
                ...
                adaugaActivitate(
                        grupID,
                        Integer.parseInt(nrMinParticipantiField.getText().trim()),
