...
public class RenuntareCurs {
    ...
    public RenuntareCurs(Stage primaryStage,SqlConexiune sql, int student_id, int user_id){

        Label headerLabel = new Label("Renunțare Curs:");
        ...
        materiiComboBox.setPromptText("Selectează o materie");
        ...
        Button stergeButton = getButton(student_id, materiiComboBox, statusLabel);
        ...
        primaryStage.setTitle("Renunțare curs");
        primaryStage.show();
    }

    private Button getButton(int student_id, ComboBox<Materie> materiiComboBox, Label statusLabel) {
        Button stergeButton = new Button("Renunță la curs");
        stergeButton.setOnAction(e -> {
            ...
            if (selectedMaterie != null) {
                ...
                statusLabel.setText("Ștergerea a fost realizată cu succes!");
                statusLabel.setTextFill(Color.GREEN);
            } else {
                statusLabel.setText("Ștergerea nu a putut fi realizată!");
